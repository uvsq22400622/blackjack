...
def carte(paquet: list, n: int) -> list:
    """Retourne la main du joueur/croupier"""
    main = []
    for _ in range(n):
...
def choix():
    """Choix du jeu"""
    global bouton_tirer, bouton_rester, main_joueur, mise_utilisateur, jeton, bouton_doubler, bouton_splitter, bouton_abandonner
